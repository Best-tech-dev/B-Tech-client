  ...
  const scheduleItems = [
    {
      ...
      description:
        "Review progress, discuss design challenges, and set daily goals",
      icon: <Users className="h-5 w-5 text-purple-600" />,
    },
    {
      time: "6:15 PM - 7:30 PM",
      activity: "Core Design Session",
      description:
        "Interactive lessons on design principles, tools, and methodologies",
      icon: <BookOpen className="h-5 w-5 text-blue-600" />,
    },
    {
      time: "7:30 PM - 7:45 PM",
      activity: "Break",
      description: "Networking and design critiques with peers",
    ...
    },
    {
      ...
      description:
        "Design exercises, tool tutorials, and practical design work",
      icon: <Clock className="h-5 w-5 text-green-600" />,
    },
    {
      time: "8:45 PM - 9:00 PM",
      activity: "Review & Feedback",
      description: "Design critiques and preview of next session",
    ...
    <section id="daily-schedule" className="mb-16">
      <div className="max-w-4xl">
        ...
        <p className="text-lg text-gray-700 mb-8 leading-relaxed">
          ...
          theory with practical design work. Each session is carefully crafted
