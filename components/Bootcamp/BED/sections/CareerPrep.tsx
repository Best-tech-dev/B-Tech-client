  ...
  const careerPaths = [
    {
      ...
      description:
        "Build server-side applications and APIs for digital products",
    },
    {
      title: "DevOps Engineer",
      salary: "₦3M - ₦8M annually",
      icon: <Briefcase className="h-6 w-6 text-green-600" />,
      description: "Manage infrastructure and deployment pipelines",
    },
    {
      title: "System Architect",
      salary: "₦4M - ₦12M annually",
      icon: <FileText className="h-6 w-6 text-purple-600" />,
      description: "Design scalable backend systems for organizations",
    },
  ];
    ...
    <section id="career-prep" className="mb-16">
      <div className="max-w-4xl">
        ...
        <p className="text-base text-gray-700 mb-8 leading-relaxed">
          ...
          competitive backend development industry with portfolio reviews,
