  ...
  const scheduleItems = [
    {
      ...
      description:
        "Review progress, discuss cloud challenges, and set daily goals",
      icon: <Users className="h-5 w-5 text-blue-600" />,
    },
    {
      time: "6:15 PM - 7:30 PM",
      activity: "Core Cloud Session",
      description:
        "Interactive lessons on cloud principles, DevOps practices, and methodologies",
      icon: <BookOpen className="h-5 w-5 text-blue-600" />,
    },
    {
      time: "7:30 PM - 7:45 PM",
      activity: "Break",
      description: "Networking and cloud architecture discussions with peers",
    ...
    },
    {
      ...
      description:
        "Cloud labs, infrastructure deployment, and practical DevOps work",
      icon: <Clock className="h-5 w-5 text-green-600" />,
    },
    {
      time: "8:45 PM - 9:00 PM",
      activity: "Review & Feedback",
      description: "Architecture reviews and preview of next session",
    ...
    <section id="daily-schedule" className="mb-16">
      <div className="max-w-4xl">
        ...
        >
          ...
          theory with practical cloud work. Each session is carefully crafted to
