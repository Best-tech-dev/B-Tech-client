...
const CareerPrep: React.FC = () => {
  const careerPaths = [
    ...
    },
    {
      ...
      salary: "₦3.5M - ₦9M annually",
      icon: <Briefcase className="h-6 w-6 text-blue-600" />,
      description:
        "Automate and optimize deployment pipelines and infrastructure",
    },
    {
    ...
    <section id="career-prep" className="mb-16">
      <div className="max-w-4xl">
        ...
        <p className="text-lg text-gray-700 mb-8 leading-relaxed">
          ...
          competitive cloud and DevOps industry with portfolio reviews,
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div>
              ...
              <p className="text-blue-800 text-sm">
                Regular one-on-one sessions with senior cloud engineers to
            ...
            <div>
              ...
              <p className="text-blue-800 text-sm">
                Mock technical challenges and system design training
              </p>
            </div>
            <div>
              <h4 className="font-semibold text-blue-900 mb-2">
              ...
              <p className="text-blue-800 text-sm">
                Access to our network of hiring managers and cloud leaders
              </p>
            </div>
            <div>
              <h4 className="font-semibold text-blue-900 mb-2">
