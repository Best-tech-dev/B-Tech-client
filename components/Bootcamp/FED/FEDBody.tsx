...
import FrontendExperience from "./sections/FrontendExperience";
...
import Testimonials from "@/components/Bootcamp/SE/sections/Testimonials";
import FAQs from "./sections/FAQs";

const ContentSection: React.FC = () => {
  const [activeSection, setActiveSection] = useState("frontend-experience");
