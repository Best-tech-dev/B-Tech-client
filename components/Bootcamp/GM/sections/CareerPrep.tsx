    ...
    <section id="career-prep" className="mb-16">
      <div className="max-w-4xl">
        ...
        <p className="text-base text-gray-700 mb-8 leading-relaxed">
          ...
          competitive growth marketing industry with portfolio reviews,
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div>
              ...
              <p className="text-green-800 text-sm">
                Regular one-on-one sessions with growth experts to refine your
                portfolio
              </p>
            </div>
            <div>
              ...
              <p className="text-green-800 text-sm">
                Mock growth challenges and presentation skills training
              </p>
            </div>
            <div>
              <h4 className="font-semibold text-green-900 mb-2">
              ...
              <p className="text-green-800 text-sm">
                Access to our network of hiring managers and growth leaders
              </p>
            </div>
            <div>
              <h4 className="font-semibold text-green-900 mb-2">
