...
import { BarChart3, Clock, FileCheck, GraduationCap } from "lucide-react";
  ...
  const requirements = [
    {
      ...
      description:
        "Interest in data, analytics, or quantitative fields (portfolio not required)",
      icon: <BarChart3 className="h-6 w-6 text-purple-600" />,
    },
    {
      title: "Time Commitment",
      description: "Ability to dedicate 15-20 hours per week for 24 weeks",
      icon: <Clock className="h-6 w-6 text-blue-600" />,
    },
    {
      title: "Application Materials",
      description:
        "Completed application form, CV, and data science motivation letter",
    ...
    <section id="admissions" className="mb-16">
      <div className="max-w-4xl">
        ...
        <p className="text-lg text-gray-700 mb-8 leading-relaxed">
          ...
          science experience is required - just passion for uncovering insights
