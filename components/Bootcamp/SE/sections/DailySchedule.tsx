...
import { Clock, Code, Users, BookOpen, Coffee } from "lucide-react";
  ...
  const scheduleItems = [
    {
      ...
      description:
        "Review progress, discuss coding challenges, and set daily development goals",
      icon: <Users className="h-5 w-5 text-blue-600" />,
    },
    {
      time: "6:15 PM - 7:30 PM",
      activity: "Core Development Session",
      description:
        "Interactive lessons on full-stack concepts with live coding demonstrations",
    ...
    },
    {
      ...
      activity: "Hands-on Coding Workshop",
      description:
        "Coding exercises, framework tutorials, and practical development work",
    ...
    <section id="daily-schedule" className="mb-16">
      <div className="max-w-4xl">
        ...
        <p className="text-lg text-gray-700 mb-8 leading-relaxed">
          ...
          theory with practical development work. Each session is carefully
