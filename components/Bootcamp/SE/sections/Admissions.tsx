  ...
  return (
    ...
    >
      ...
      <p className="text-sm md:text-base text-gray-700 mb-6 max-w-3xl">
        This Software Engineering Bootcamp, with its in-depth curriculum
        covering computer science fundamentals to front-end and back-end web
        development, is designed for motivated students passionate about
        technology.
      </p>

      <p className="text-sm md:text-base text-gray-700 mb-6 max-w-3xl">
        The Software Engineering Immersive&apos;s accelerated timeline is
