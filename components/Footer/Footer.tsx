...
const Footer = () => {
  ...
  return (
    <div className=" bg-[#0e1117] border-t border-t-gray-500">
      <div className="bg-[#0e1117] text-white px-6 md:px-10 py-6 flex flex-col md:flex-row md:justify-between md:items-center text-center md:text-left max-w-7xl mx-auto">
        {/* Logo */}
